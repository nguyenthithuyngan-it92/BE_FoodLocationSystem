    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paymentmethod', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='menufood.paymentmethod')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menu_item', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='menufood.menuitem')),
                ('tags', models.ManyToManyField(related_name='foods', to='menufood.tag')),
            ],
            options={
                'abstract': False,
            },
